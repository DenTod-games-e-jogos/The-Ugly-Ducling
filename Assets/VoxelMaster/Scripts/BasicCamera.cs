...
namespace VoxelMaster
{
    public class BasicCamera : MonoBehaviour
    {
        ...
        void OnGUI()
        {
            if (GUI.Button(new Rect(10, 10, 200, 20), "Voxel Generation"))
            {
                SceneManager.LoadScene("Voxel Master Generation");
            }

            if (GUI.Button(new Rect(10, 30, 200, 20), "Voxel Shapes"))
            {
                SceneManager.LoadScene("Voxel Master Shapes");
            }

            if (GUI.Button(new Rect(10, 50, 200, 20), "Voxel Helpers"))
            {
                SceneManager.LoadScene("Voxel Master Helpers");
            }

            if (GUI.Button(new Rect(10, 70, 200, 20), "Voxel Loading-Saving System"))
            {
                SceneManager.LoadScene("Voxel Master Loading-Saving System");
            }

            if (GUI.Button(new Rect(10, 90, 200, 20), "Voxel Master Loading System"))
            {
