    ...
    public static void Behave (VoxelState voxel) 
    {
        switch (voxel.id) 
        {
            case 3:
            {
                ...
                if ((voxel.neighbours[0] != null && voxel.neighbours[0].id == 5))
                {
                    neighbours.Add(voxel.neighbours[0]);
                }

                if ((voxel.neighbours[1] != null && voxel.neighbours[1].id == 5))
                {
                    neighbours.Add(voxel.neighbours[1]);
                }

                if ((voxel.neighbours[4] != null && voxel.neighbours[4].id == 5)) 
                {
                    neighbours.Add(voxel.neighbours[4]);
                }

                if ((voxel.neighbours[5] != null && voxel.neighbours[5].id == 5)) 
                {
                    neighbours.Add(voxel.neighbours[5]);
                }
